...
- Included: QR attendance, branded church check-in, membership registry, Excel export.
- Everything else is crossed out on the card and locked in the app. That reports, email, Ask Mene, leaders, groups, SMS, automations, follow-ups and branding extras.
- Any church can pick Free when signing up. There's no trial and no payment, and they can upgrade from Billing at any time.
- Free limits start at 1 staff seat, 150 members and 0 messages. You can change these later.
